...
fileUploadButton.addEventListener('change', function() {
    ...
    /* once a file is added, change the fileChosen text to reflect the name of 
       the file uploaded */
    ...
    fileReader.onload = function() {
        ...
        for (var line = MAP_START_LINE; line < lines.length-1; line++) {
            ...
            if (lines[line - 1] === ""
                ...
                &&  (line + 2 == lines.length ||
                    lines[line + 2].indexOf('\t') == -1)) { /* tab or last line in file */
                /* if line is empty or the last line of a file */
        ...
        /* add title, dueDate, headNode to sessionStorage */
        ...
        /* verify that date is real:
         * checks that there is fact data stored in date
         * AND that the date stored is real */
